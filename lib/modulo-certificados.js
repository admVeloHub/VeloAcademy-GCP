// VERSION: v2.0.1 | DATE: 2026-04-23 | modulo_certificados: sem temasConcluídos em $setOnInsert (conflito com $addToSet)
...
async function tryRegisterModuloAfterTemaEvent(db, email, colaboradorNome, hint) {
    ...
    // Não colocar temasConcluídos em $setOnInsert: no mesmo update o $addToSet no mesmo path gera
    // "Updating the path ... would create a conflict" (MongoDB).
